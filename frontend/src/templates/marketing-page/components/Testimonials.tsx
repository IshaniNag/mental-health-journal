    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary' }}>
          See how our users are improving their well-being and gaining clarity through journaling. Discover how our analyzer supports mental wellness, reflection, and emotional growth. Join a community dedicated to mindfulness, self-care, and personal insight.
        </Typography>
      </Box>
